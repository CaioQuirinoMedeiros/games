...
let scores, roundScore, activePlayer, dice1, dice2, gamePlaying, winPoints, dice1DOM, dice2DOM;
config();
...
document.querySelector('#win-points-slider').addEventListener('mousemove', function() {
    document.querySelector('#win-points').value = document.querySelector('#win-points-slider').value
});
...
// Start Game
function init() {
    if (document.getElementById('player-0-name').value === '' || document.getElementById('player-1-name') === '') {
